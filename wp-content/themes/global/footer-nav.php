 ...
 <!-- producto1  Modal -->
 <div class="modal fade" id="producto2-modal" tabindex="-1", role="dialog", aria-labelledby="myModalLabel", aria-hidden="true">
   ...
   <div class="col-xs-12 no-padding cont-producto">
             ...
             <div id="product1-1" class="col-sm-12 col-md-5 c1-modal">
             ...
             <div id="product1" class="col-xs-12 col-md-7 c2-modal">
                ...
                <h2> ESTRUCTURAS DE 
                      <br><span>DESPLIEGUE RÁPIDO</span>
                </h2>

                <p>Ofrecemos eficientes estructuras temporales o permanentes con 
                diseños que se ajustan a los estándares internacionales de construcción. 
                  Asesoramos al cliente en una solución técnica para cada necesidad.</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 no-padding">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 ser-description product-module ">
                    <h3 class="benefit-title">ESPACIOS</h3>
                      <hr>
                      
                      <p>No requieren de columnas internas otorgando mayor espacio útil
                       y facilidad de movimiento para almacenar y operar montacargas y otros vehículos.
                        <br><br>Su sistema modular permite adaptarse al tamaño que el cliente necesite.</p>
                    </div>
                  </div>
                  ...
                  <div class="col-xs-12">
                    ...
                    <h3 class="benefit-title">MOVILIDAD</h3>
                      <hr>
                      <p>Pueden ser movilizadas vía aérea, terrestre o fluvial. 
                      1.400mts2 de estructuras pueden ser transportadas en un contenedor de 40 pies. </p>
                    </div> 
                  </div>
                  ...
                  <div class="col-xs-12 ">
                    ...
                    <h3 class="benefit-title">RAPIDEZ</h3>
                      <hr>
                      <p>Nuestras estructuras son instaladas
                        en horas. Los requerimientos de
                        cimentación son mínimos. Permiten
                        que se agranden o se dividan. Que
                        sean armadas, desarmadas, movidas
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 no-padding">
                  ...
                  <div class="col-xs-12">
                    <div class="col-xs-12  ser-description product-module ">
                    <h3 class="benefit-title">DISMINUCIÓN DE COSTOS</h3>
                      <hr>
                      
                      <p>Bajos costos en comparación con los
                          sistemas tradicionales, gracias a:
                          <br>
                          <br>-Rápida instalación
                          <br>-No requiere preparación del terreno
                          <br>-Fácil transporte
                          <br>-Permite su reubicación
                          </p>
                    </div>
                  </div>
                  ...
                  <div class="col-xs-12 ">
                    <div class="col-xs-12  ser-description product-module ">
                    <h3 class="benefit-title">AHORRO DE ENERGIA</h3>
                      <hr>
                      
                      <p>La cubierta de membrana de PVC
                      elimina la necesidad de iluminación
                      artificial durante el día. Su sistema de
                      ventilación natural proporciona un
                      entorno sin humedad.
                      <br>
                      <br>
                      En su interior mantiene una temperatura de 15 a 20 grados más fría en
                      verano y 15 a 20 grados más cálida en
                      invierno.
                      </p>     
                    </div>
                  </div>
                  ...
                  <div class="col-xs-12">
                    ...
                    <h3 class="benefit-title">DURABILIDAD</h3>
                      ...
                      <p>Nuestras estructuras tienen la capacidad de resistir a condiciones ambientales extremas.</p>
                    </div>
                  </div>
                ...
                <div class="col-xs-12 col-md-6 col-md-offset-6 no-padding ">
                  <div class="col-xs-12 col-sm-12  footer-cp call2-action-ser">
                    <a data-toggle="modal" data-target="#contact-modal" href="">
                      <div class="col-xs-12  contact-btn visible-lg visible-md">
                        <div class="col-xs-12 contact-btn-3 va">
                          <div class="col-xs-8 va">
 ...
 <!-- contact Modal -->
 <div class="modal modal2 modal-contacto fade" id="contact-modal" tabindex="-1", role="dialog", aria-labelledby="myModalLabel", aria-hidden="true">
  ...
  <!-- Nou  Modal -->
   <div class="modal modal2 fade no-padding" id="nou" tabindex="-1", role="dialog", aria-labelledby="myModalLabel", aria-hidden="true">
      <div class="col-xs-12 col-sm-12 col-sm-offset-0 col-md-12 col-md-offset-0  col-lg-3 col-lg-offset-9 pull-right header-pro header-pro2 ">
   ...
   <!-- contact Modal -->
  <div class="modal modal2 modal-contacto fade" id="nou-contact" tabindex="-1", role="dialog", aria-labelledby="myModalLabel", aria-hidden="true">
  ...
  <script type="text/javascript">
    $(document).scroll(function() {
      ...
      if (documentScrollTop > $('#mycarousel').height()-130) {
        console.log("wtf");
        $('.navbar-navigation').addClass('fixedattop');
        var shiftContent = $('.navbar-navigation').height();
        
      }
      else if ($('.navbar-navigation').hasClass('fixedattop')) {
        $('.navbar-navigation').removeClass('fixedattop');
    ...
    $(document).ready(function() {
      ...
      $("#h-screen").backstretch([
                "https://s3.amazonaws.com/cannedhead.smartbrix/inicio-1.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/inicio-2.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/inicio-3.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/inicio-4.jpg"
            ], {duration: 2000, fade: 750});

    

    $('#myBlock').vide('https://s3.amazonaws.com/cannedhead.smartbrix/video-home-smartbrix.mp4', {
    
    });


      $("#product1").backstretch([
                "https://s3.amazonaws.com/cannedhead.smartbrix/construccion-1.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/construccion-2.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/construccion-3.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/construccion-4.jpg"
            ], {duration: 2000, fade: 750});

      $("#product1-1").backstretch([
                "https://s3.amazonaws.com/cannedhead.smartbrix/estructuras-1.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/estructuras-2.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/estructuras-3.jpg",
                "https://s3.amazonaws.com/cannedhead.smartbrix/estructuras-4.jpg"
            ], {duration: 2000, fade: 750});
