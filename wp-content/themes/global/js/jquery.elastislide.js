(function( window, $, undefined ) {
	...
	$.elastislide.prototype 	= {
		...
		_addControls		: function() {
			...
			this.$navNext	= $('<span class=" hidden es-nav-next"><i class="ion-chevron-right va center-block"></i></span>');
			this.$navPrev	= $('<span class=" hidden es-nav-prev"><i class="ion-chevron-left va center-block"></i></span>');
			$('<div class="es-nav"/>')
			.append( this.$navPrev )
			.append( this.$navNext )
			.appendTo( this.$el );
